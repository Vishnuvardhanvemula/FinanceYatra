...
// Hardcoded content from frontend/src/data/modules/module-1-banking.js
// I am copying this manually because importing from frontend is problematic in Node environment
...
const migrate = async () => {
    try {
        ...
        if (module) {
            console.log('Found module-1, updating content...');
            module.lessons = module1Content.lessons;
            await module.save();
            console.log('Module 1 content updated successfully!');
        } else {
