    ...
    <div className="max-w-[800px]">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button className="w-full sm:w-auto group relative px-8 py-4 bg-teal-500 text-[#0b101b] rounded-xl font-bold text-lg overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(20,184,166,0.4)]">
            <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
            <span className="relative flex items-center gap-2">Start Learning <ArrowRight size={20}/></span>
          </button>
  ...
  <section className="min-h-[80vh] flex flex-col items-center justify-center text-center px-6 relative z-10">
    <div className="max-w-4xl">
       ...
       >
          ...
          <button className="w-full sm:w-auto px-12 py-6 bg-gradient-to-r from-teal-500 to-emerald-600 text-white rounded-2xl font-bold text-xl hover:scale-105 transition-transform shadow-[0_0_60px_rgba(20,184,166,0.4)]">
            Create Free Account
          </button>
       </motion.div>
    </div>
